...
def plot_trajectory_loop(data, method_name, dep_var, title, ylabel, pdf):
    ...
    3. Explicit Reference Year (1973 set to 0)
    """
    ...
    # 2. Formula with explicit Reference Year (1973)
    # This ensures that all coefficients represent the difference relative to 1973
    formula = f"{dep_var} ~ is_high_energy * C(year, Treatment(reference=1973)) + log_emp + C(naics)"
    ...
    try:
        ...
        interaction_prefix = "is_high_energy:C(year, Treatment(reference=1973))"
